...
module.exports = class Client extends EventEmitter {
    ...
    handlemessage(message) {
        if (message.root.attributes.type == "chat") {
            ...
            if (msg == "!Credits" || msg == "!Credits" || msg == "!Credits")
                this.sendChat(this.botJid, "EgatorFN + In-Game: egator6#3053")
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "account_dn": "LuxFNBot",
                            "member_state_updated": {
                                "urn:epic:member:joinrequestusers_j": "{\"users\":[{\"id\":\"LuxFNBot\",\"dn\":\"LuxFNBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}",
                                "urn:epic:member:dn_s": "LuxFNBot"
                            },
                            "joined_at": new Date(),
                            "updated_at": new Date()
